...
let totalMessages = 0
let totalWords = {}
exports.totalMessages = totalMessages
...
const createUserObject = async (web, channel='general') => {
  //get channels
...
const displayResults = u => {
    ...
    Object.keys(u).forEach( user => {
      console.log("--" + yellow + u[user].real_name + white + "--")
...
exports.run = async (verificationToken, channel='general') => {
  try {
